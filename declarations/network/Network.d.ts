...
export interface Options {
  ...
  configure?: any; // https://visjs.github.io/vis-network-advanced/docs/network/configure.html
  ...
  layout?: any; // https://visjs.github.io/vis-network-advanced/docs/network/layout.html

  interaction?: any; // https://visjs.github.io/vis-network-advanced/docs/network/interaction.html?keywords=edges

  manipulation?: any; // https://visjs.github.io/vis-network-advanced/docs/network/manipulation.html

  physics?: any; // https://visjs.github.io/vis-network-advanced/docs/network/physics.html
}
